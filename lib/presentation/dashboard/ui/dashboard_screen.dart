      ...
      body: ListView(
        ...
        children: [
          _DashboardCard(
            ...
            subtitle: 'Practice configured pages with a 30s timer.',
            color: AppTheme.primaryContainer,
            onTap: () => context.push(RepetitionCountingScreen.route),
          ),
          const SizedBox(height: 8),
          TextButton.icon(
            onPressed: () => context.push('/manage-pages/repetition_counting'),
            icon: const Icon(Icons.edit_outlined),
            label: const Text('Edit repetition pages'),
          ),
          const SizedBox(height: 16),
          _DashboardCard(
            icon: Icons.timer_outlined,
            title: 'Time Measurement',
            subtitle: 'Practice configured pages and time yourself.',
            color: AppTheme.secondaryContainer,
            onTap: () => context.push(TimeMeasurementScreen.route),
          ),
          const SizedBox(height: 8),
          TextButton.icon(
            onPressed: () => context.push('/manage-pages/time_measurement'),
            icon: const Icon(Icons.edit_outlined),
            label: const Text('Edit time measurement pages'),
          ),
          const SizedBox(height: 16),
          _DashboardCard(
          ...
          _DashboardCard(
            ...
            subtitle: 'Create modules and assign pages.',
